...
export const homePopup = document.querySelector('.home-popup');
export const homePopupBtnOk = document.querySelector('.home-popup__btn-ok');
...
export const galleryNavButton = document.querySelector('.nav__item-gallery');
...
export const containerGallery = document.createElement('div');
